...
const EditorPage = () => {
  ...
  const [isDesignDraggable, setIsDesignDraggable] = useState(true); // Control design draggability
    ...
    <div className="flex flex-col h-screen overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <Sidebar
          ...
          isDesignDraggable={isDesignDraggable}
          setIsDesignDraggable={setIsDesignDraggable}
        />
            ...
            {isLoading ? (
              ...
              <Suspense fallback={<LoadingState />}>
                <KonvaComponents
                  ...
                  enableDesignDrag={isDesignDraggable} // Pass draggability state
                />
              </Suspense>
            ) : (
